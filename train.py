...
if __name__ == "__main__":
    ...
    train_parser.add_argument(
        "--dataset", type=str, default="shrec", help="iseg2017 / task02_heart / task04_hippocampus / luna16 / shrec/ invitro"
    )
    ...
    train_parser.add_argument("--num_samples", type=int, default=32, help="Effective batch size: batch_size x num_samples")
    ...
    earlystopping_callback = EarlyStopping(monitor="val_dice", patience=10, mode="max")
    ...
    shutil.copyfile("train.py", os.path.join(outpath, "train_" + str(DSName) + ".txt"))
