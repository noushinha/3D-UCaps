...
class SHRECDataModule(pl.LightningDataModule):
    class_weight = np.asarray([0.01361341, 0.29879553, 0.30879553, 0.37879553])
    ...
    def train_dataloader(self):
        print("training batch size is:  ", self.batch_size)
...
if __name__ == "__main__":
    data_module = SHRECDataModule(root_dir="/mnt/Data/Cryo-ET/3D-UCaps/data/shrec3/")
