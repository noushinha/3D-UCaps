...
if __name__ == "__main__":
    ...
    val_parser.add_argument(
        "--dataset", type=str, default="invitro", help="iseg2017 / task02_heart / task04_hippocampus / luna16 / invitro"
    )
    val_parser.add_argument("--fold", type=int, default=0)
    val_parser.add_argument(
        "--checkpoint_path", type=str,
        default='/mnt/Data/Cryo-ET/3D-UCaps/logs/ucaps_invitro_0/version_3/checkpoints/epoch=292-val_dice=0.8783.ckpt',
    ...
    # cnt = 0
    # nifti_output_dir = '/mnt/Data/Cryo-ET/3D-UCaps/data/invitro/'
    for i, data in enumerate(tqdm(val_loader)):
        ...
        if args.save_image:
            if args.dataset == "iseg2017":
                ...
                #     # patch_num_nifti = i - 1
                #     # print("labelsTs/patch_m00_p" + str(cnt) + ".nii.gz")
                #     patch_tomo_name = "output/labelsTs/patch_m00_p" + str(cnt) + ".nii.gz"
